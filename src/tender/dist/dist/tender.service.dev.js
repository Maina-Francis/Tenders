      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , rxjs_1.firstValueFrom(this.httpService.get(url))];

          case 1:
            data = _a.sent().data;
            filteredData = [];

            _loop_1 = function _loop_1(tender) {
              var tenderTitle = tender.title.toLowerCase(); // check whether the title includes the keywords
          ...
          case 2:
            if (!(i < filteredData.length)) return [3
            /*break*/
            , 7];
            return [4
            /*yield*/
            , this.tenderModel.find({
              id_tenderdetails: filteredData[i].id_tenderdetails
            })];

          case 3:
            checkFromDb = _a.sent();
            if (!(checkFromDb.length == 0)) return [3
            /*break*/
            , 6];
            return [4
            /*yield*/
            , this.tenderModel.create(filteredData[i])];
          ...
          case 4:
            ...
            return [4
            /*yield*/
            , this.newTenderModel.create(filteredData[i])];
          ...
          case 7:
            ...
            return [2
            /*return*/
            , 'Successfully updated the tender data'];
        }
      });
    });
  };
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            ...
            return [2
            /*return*/
            , 'New tenders added to the collection'];
        }
      });
    });
  };

  __decorate([schedule_1.Cron('0 0 6 * * *') //runs every day @6am
  ], TenderService.prototype, 'getTenders');

  __decorate([schedule_1.Cron('0 15 6 * * *') //everyday @6:15am
  ], TenderService.prototype, 'getNewTenders');

  TenderService = __decorate([common_1.Injectable(), __param(0, mongoose_1.InjectModel(tender_schema_1.Tender.name)), __param(1, mongoose_1.InjectModel('newTenders'))], TenderService);
